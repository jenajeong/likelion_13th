...
urlpatterns = [
    ...
    path('api/users/', UserRegistrationView, name='user-registration'),
    path('api/users/login/', UserLoginView, name='user-login'),
    path('api/users/logout/', UserLogoutView, name='user-logout'),
